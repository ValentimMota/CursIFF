...
<head>
    ...
    <title>Lobby ALM - Instituto Federal Farroupilha</title>
...
<body>
    ...
    <div class="container mt-5">
        <h2>Curso Técnico em ALM - Instituto Federal Farroupilha</h2>
        <div class="row">
            <div class="col-md-4">
                <a class="nav-item nav-link" href="ano_alm1.php">
                    <div class="card">
                        <div class="card-body">
            ...
            <div class="col-md-4">
                <a class="nav-item nav-link" href="ano_alm2.php">
                    <div class="card">
                        <div class="card-body">
            ...
            <div class="col-md-4">
                <a class="nav-item nav-link" href="ano_alm3.php">
                    <div class="card">
                        <div class="card-body">
