...
<head>
    ...
    <title>1º Ano AGRO - Instituto Federal</title>
...
<body>
    ...
    <h1 class="centered-text">1° Ano Agro</h1>
    <p class="centered-text2">Durante o primeiro ano são introduzidos conceitos sobre a área de Agro, matérias como Agricultura Geral, Biologia, Física e Química são essenciais para o entendimento desta área.</p>

    <div class="container">
        <?php
        $disciplinas = array(
            array('nome' => 'Agricultura Geral', 'imagem' => 'agricultura.png', 'horas' => '100h'),
            array('nome' => 'Artes', 'imagem' => 'artesimg.png', 'horas' => '33h'),
            array('nome' => 'Biologia', 'imagem' => 'bioimg.png', 'horas' => '100h'),
            ...
            array('nome' => 'Informática Básica', 'imagem' => 'informatica.png', 'horas' => '33h'),
            ...
            array('nome' => 'Sociologia', 'imagem' => 'sociologia.png', 'horas' => '66h'),
            array('nome' => 'Zootecnia Geral', 'imagem' => 'zootecnia.png', 'horas' => '100h'),
        );
